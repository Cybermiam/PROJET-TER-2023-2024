...
#
#example :     ttl2trig   ../triple_store_data/qualifications.ttl brocartsThesaurus ../triple_store_data/qualifications.trig
#
...
if [[ "$OSTYPE" == "darwin"* ]]; then
    ...
    gsed '/^@prefix/!b;:a;n;/./ba;i:'$2' \{' $1 > $3
elif [[ "$OSTYPE" == "linux-gnu" ]]; then
    # Running on Ubuntu or another Linux distribution"
    # add the named graph declaration in the first empty line after prefixes"
    sed '/^@prefix/!b;:a;n;/./ba;i:'$2' \{' $1 > $3
else
